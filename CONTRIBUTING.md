...
Report bugs at [`github.com/bella-mir/geo-python`][repo].
...
`geo-python` could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at [`github.com/bella-mir/geo-python`][repo].
...
Ready to contribute? Here's how to set up `geo-python` for local development.

1. Fork the `geo-python` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:bella-mir/geo-python.git
   ```
...
[repo]: https://github.com/bella-mir/geo-python/issues
