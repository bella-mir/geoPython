...
Таким образом, вы не только **освоите методы пространственного анализа на Python** и познакомитесь с библиотеками Python для работы с геоданными, но и **выполните проект**, результаты котрого отобразите на интерактивной карте и опубликуете в открытом доступе (при желании).
