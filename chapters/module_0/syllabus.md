...
К каждому модулю есть задание — этап проекта по оценке доступности повседневных функций выбранного вами города в рамках концепции 15-минутного города. Ноутбуки с заданиями и видеоразборы занятий доступны в [бандле курса на Boosty](https://boosty.to/bellamir/bundle/810f0481-b240-44b7-a08f-1b5c10b0e4f6?share=bundle_link).
